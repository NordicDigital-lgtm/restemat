      ...
      <div className="bg-gradient-to-br from-primary/10 via-accent/10 to-transparent p-6 sm:p-7">
        <div className="relative">
          {recipe.timeEstimateMin && (
            <span className="absolute top-0 right-0 inline-flex items-center gap-1 rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
              <Clock className="h-3.5 w-3.5" />
              {recipe.timeEstimateMin} min
            </span>
          )}
          <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl pr-24">{recipe.name}</h2>
        </div>
